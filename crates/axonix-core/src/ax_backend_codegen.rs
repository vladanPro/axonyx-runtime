...
pub fn generate_backend_module(plan: &AxBackendPlan) -> Result<String, AxBackendCodegenError> {
    ...
    out.push_str("// @generated by Axonix backend draft codegen\n");
    out.push_str("use std::collections::BTreeMap;\n\n");
    out.push_str("use axonix_runtime::backend_prelude::*;\n");
...
mod tests {
    ...
    fn generates_loader_and_action_module_against_runtime_traits() {
        ...
        assert!(module.contains("use axonix_runtime::backend_prelude::*;"));
